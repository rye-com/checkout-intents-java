...
import com.checkout_intents.api.core.http.HttpRequestBody
import com.checkout_intents.api.core.http.HttpResponse
import com.checkout_intents.api.errors.CheckoutIntentsIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw CheckoutIntentsIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(CheckoutIntentsIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("CHECKOUT_INTENTS_LOG")?.lowercase()) {
