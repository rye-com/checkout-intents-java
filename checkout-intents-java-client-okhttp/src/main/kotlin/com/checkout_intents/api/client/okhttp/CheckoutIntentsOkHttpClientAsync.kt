...
package com.checkout_intents.api.client.okhttp

import com.checkout_intents.api.client.CheckoutIntentsClientAsync
import com.checkout_intents.api.client.CheckoutIntentsClientAsyncImpl
import com.checkout_intents.api.core.ClientOptions
import com.checkout_intents.api.core.Sleeper
import com.checkout_intents.api.core.Timeout
import com.checkout_intents.api.core.http.AsyncStreamResponse
import com.checkout_intents.api.core.http.Headers
import com.checkout_intents.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [CheckoutIntentsClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class CheckoutIntentsOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [CheckoutIntentsClientAsync].
         */
         ...
         */
        @JvmStatic fun fromEnv(): CheckoutIntentsClientAsync = builder().fromEnv().build()
    }

    /** A builder for [CheckoutIntentsOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.checkout_intents.api.core.jsonMapper]. The default is usually sufficient
        ...
        /**
         * Returns an immutable instance of [CheckoutIntentsClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CheckoutIntentsClientAsync =
            CheckoutIntentsClientAsyncImpl(
                clientOptions
                    .httpClient(
