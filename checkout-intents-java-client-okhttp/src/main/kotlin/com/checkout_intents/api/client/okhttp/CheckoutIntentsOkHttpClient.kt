...
import com.checkout_intents.api.client.CheckoutIntentsClientImpl
...
/**
 * A class that allows building an instance of [CheckoutIntentsClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class CheckoutIntentsOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CheckoutIntentsClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): CheckoutIntentsClient = builder().fromEnv().build()
    }

    /** A builder for [CheckoutIntentsOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CheckoutIntentsClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CheckoutIntentsClient =
            CheckoutIntentsClientImpl(
                clientOptions
                    .httpClient(
