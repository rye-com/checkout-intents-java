...
dependencies {
    testImplementation(project(":checkout-intents-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../checkout-intents-java-core/src/main/resources/META-INF/proguard/checkout-intents-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.checkout_intents.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../checkout-intents-java-core/src/main/resources/META-INF/proguard/checkout-intents-java-core.pro",
