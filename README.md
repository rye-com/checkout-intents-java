...
[![Maven Central](https://img.shields.io/maven-central/v/com.rye/checkout-intents)](https://central.sonatype.com/artifact/com.rye/checkout-intents/0.2.2)
[![javadoc](https://javadoc.io/badge2/com.rye/checkout-intents/0.2.2/javadoc.svg)](https://javadoc.io/doc/com.rye/checkout-intents/0.2.2)
...
The REST API documentation can be found on [docs.rye.com](https://docs.rye.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.rye/checkout-intents/0.2.2).
...
```kotlin
implementation("com.rye:checkout-intents:0.2.2")
```
