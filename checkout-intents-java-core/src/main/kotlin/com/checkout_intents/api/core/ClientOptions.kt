...
package com.checkout_intents.api.core
...
import com.checkout_intents.api.core.http.PhantomReachableClosingHttpClient
import com.checkout_intents.api.core.http.QueryParams
import com.checkout_intents.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Defaults to [com.checkout_intents.api.core.jsonMapper]. The default is usually sufficient and
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            (System.getProperty("checkoutintents.baseUrl")
                    ?: System.getenv("CHECKOUT_INTENTS_BASE_URL"))
                ?.let { baseUrl(it) }
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "checkout-intents-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
