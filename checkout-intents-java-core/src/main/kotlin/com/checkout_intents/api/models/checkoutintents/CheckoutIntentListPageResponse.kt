...
class CheckoutIntentListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<CheckoutIntent>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CheckoutIntent>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CheckoutIntent> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CheckoutIntent>> = data
    ...
    companion object {
         ...
         * [CheckoutIntentListPageResponse].
         *
    ...
    /** A builder for [CheckoutIntentListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CheckoutIntent>>? = null
        private var pageInfo: JsonField<PageInfo>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(checkoutIntentListPageResponse: CheckoutIntentListPageResponse) = apply {
            data = checkoutIntentListPageResponse.data.map { it.toMutableList() }
            pageInfo = checkoutIntentListPageResponse.pageInfo
            additionalProperties =
                checkoutIntentListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CheckoutIntent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CheckoutIntent>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CheckoutIntent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CheckoutIntent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CheckoutIntent) = apply {
            this.data =
        ...
        /** Alias for calling [addData] with `CheckoutIntent.ofRetrievingOffer(retrievingOffer)`. */
        fun addData(retrievingOffer: CheckoutIntent.RetrievingOfferCheckoutIntent) =
            addData(CheckoutIntent.ofRetrievingOffer(retrievingOffer))

        /**
         * Alias for calling [addData] with
         * `CheckoutIntent.ofAwaitingConfirmation(awaitingConfirmation)`.
         */
        ...
        fun addData(placingOrder: CheckoutIntent.PlacingOrderCheckoutIntent) =
            addData(CheckoutIntent.ofPlacingOrder(placingOrder))

        /** Alias for calling [addData] with `CheckoutIntent.ofCompleted(completed)`. */
        fun addData(completed: CheckoutIntent.CompletedCheckoutIntent) =
            addData(CheckoutIntent.ofCompleted(completed))

        /** Alias for calling [addData] with `CheckoutIntent.ofFailed(failed)`. */
        fun addData(failed: CheckoutIntent.FailedCheckoutIntent) =
            addData(CheckoutIntent.ofFailed(failed))
        ...
        /**
         * Returns an immutable instance of [CheckoutIntentListPageResponse].
         *
         ...
         */
        fun build(): CheckoutIntentListPageResponse =
            CheckoutIntentListPageResponse(
    ...
    fun validate(): CheckoutIntentListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CheckoutIntentListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CheckoutIntentListPageResponse{data=$data, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
