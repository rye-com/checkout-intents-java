...
dependencies {
    testImplementation(project(":checkout-intents"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../checkout-intents-core/src/main/resources/META-INF/proguard/checkout-intents-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../checkout-intents-core/src/main/resources/META-INF/proguard/checkout-intents-core.pro",
