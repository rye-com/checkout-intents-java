...
class CheckoutIntentCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CheckoutIntentCreateParams].
         *
    ...
    /** A builder for [CheckoutIntentCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(checkoutIntentCreateParams: CheckoutIntentCreateParams) = apply {
            body = checkoutIntentCreateParams.body.toBuilder()
            additionalHeaders = checkoutIntentCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = checkoutIntentCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CheckoutIntentCreateParams].
         *
         ...
         */
        fun build(): CheckoutIntentCreateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{buyer=$buyer, productUrl=$productUrl, quantity=$quantity, constraints=$constraints, discoverPromoCodes=$discoverPromoCodes, promoCodes=$promoCodes, referenceId=$referenceId, variantSelections=$variantSelections, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CheckoutIntentCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CheckoutIntentCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
