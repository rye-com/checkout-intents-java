...
class BillingListTransactionsResponse
...
private constructor(
    ...
    ) : this(id, amount, createdAt, description, metadata, mutableMapOf())
    ...
    /** A builder for [BillingListTransactionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingListTransactionsResponse: BillingListTransactionsResponse) =
            apply {
                id = billingListTransactionsResponse.id
                amount = billingListTransactionsResponse.amount
                createdAt = billingListTransactionsResponse.createdAt
                description = billingListTransactionsResponse.description
                metadata = billingListTransactionsResponse.metadata
                additionalProperties =
                    billingListTransactionsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BillingListTransactionsResponse].
         *
         ...
         */
        fun build(): BillingListTransactionsResponse =
            BillingListTransactionsResponse(
                checkRequired("id", id),
     ...
     *   its expected type.
     */
    fun validate(): BillingListTransactionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BillingListTransactionsResponse &&
            id == other.id &&
            amount == other.amount &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, amount, createdAt, description, metadata, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BillingListTransactionsResponse{id=$id, amount=$amount, createdAt=$createdAt, description=$description, metadata=$metadata, additionalProperties=$additionalProperties}"
}
