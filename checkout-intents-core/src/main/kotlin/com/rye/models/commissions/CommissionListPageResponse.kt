...
/**
 * Paginated commissions response. Use `pageInfo.endCursor` as the next page's `after` query
 * parameter to walk forward; use `pageInfo.startCursor` as the next page's `before` query parameter
 * to walk backward.
 */
class CommissionListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<Commission>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Commission>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Commission> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Commission>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommissionListPageResponse].
         *
    ...
    /** A builder for [CommissionListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Commission>>? = null
        private var pageInfo: JsonField<PageInfo>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(commissionListPageResponse: CommissionListPageResponse) = apply {
            data = commissionListPageResponse.data.map { it.toMutableList() }
            pageInfo = commissionListPageResponse.pageInfo
            additionalProperties = commissionListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<Commission>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Commission>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Commission>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Commission] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Commission) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CommissionListPageResponse].
         *
         ...
         */
        fun build(): CommissionListPageResponse =
            CommissionListPageResponse(
     ...
     *   its expected type.
     */
    fun validate(): CommissionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommissionListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CommissionListPageResponse{data=$data, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
