...
class ProductSubscriptionStore
...
private constructor(
    ...
    ) : this(domain, subscribed, type, url, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductSubscriptionStore].
         *
    ...
    /** A builder for [ProductSubscriptionStore]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productSubscriptionStore: ProductSubscriptionStore) = apply {
            domain = productSubscriptionStore.domain
            subscribed = productSubscriptionStore.subscribed
            type = productSubscriptionStore.type
            url = productSubscriptionStore.url
            additionalProperties = productSubscriptionStore.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProductSubscriptionStore].
         *
         ...
         */
        fun build(): ProductSubscriptionStore =
     ...
     *   its expected type.
     */
    fun validate(): ProductSubscriptionStore = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductSubscriptionStore &&
            domain == other.domain &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(domain, subscribed, type, url, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ProductSubscriptionStore{domain=$domain, subscribed=$subscribed, type=$type, url=$url, additionalProperties=$additionalProperties}"
}
