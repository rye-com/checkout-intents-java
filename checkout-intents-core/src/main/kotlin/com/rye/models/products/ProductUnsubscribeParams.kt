...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductUnsubscribeParams].
         *
    ...
    /** A builder for [ProductUnsubscribeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productUnsubscribeParams: ProductUnsubscribeParams) = apply {
            body = productUnsubscribeParams.body.toBuilder()
            additionalHeaders = productUnsubscribeParams.additionalHeaders.toBuilder()
            additionalQueryParams = productUnsubscribeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProductUnsubscribeParams].
         *
         ...
         */
        fun build(): ProductUnsubscribeParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductUnsubscribeParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ProductUnsubscribeParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
