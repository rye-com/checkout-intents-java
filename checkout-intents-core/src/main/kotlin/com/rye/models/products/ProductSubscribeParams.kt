...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductSubscribeParams].
         *
    ...
    /** A builder for [ProductSubscribeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productSubscribeParams: ProductSubscribeParams) = apply {
            body = productSubscribeParams.body.toBuilder()
            additionalHeaders = productSubscribeParams.additionalHeaders.toBuilder()
            additionalQueryParams = productSubscribeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProductSubscribeParams].
         *
         ...
         */
        fun build(): ProductSubscribeParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductSubscribeParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ProductSubscribeParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
