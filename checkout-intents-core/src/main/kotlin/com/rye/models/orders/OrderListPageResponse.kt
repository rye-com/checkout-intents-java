...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderListPageResponse].
         *
    ...
    /** A builder for [OrderListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderListPageResponse: OrderListPageResponse) = apply {
            data = orderListPageResponse.data.map { it.toMutableList() }
            pageInfo = orderListPageResponse.pageInfo
            additionalProperties = orderListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderListPageResponse].
         *
         ...
         */
        fun build(): OrderListPageResponse =
     ...
     *   its expected type.
     */
    fun validate(): OrderListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "OrderListPageResponse{data=$data, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
