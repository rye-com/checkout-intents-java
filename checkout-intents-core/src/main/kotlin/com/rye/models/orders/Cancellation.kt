...
private constructor(
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitRequested(requested: RequestedCancellation) = requested.validity()

                override fun visitCompleted(completed: CompletedCancellation) = completed.validity()
    ...
    /**
     * An interface that defines how to map each variant of [Cancellation] to a value of type [T].
     */
    interface Visitor<out T> {
         ...
         *
         * An instance of [Cancellation] can contain an unknown variant if it was deserialized from
    ...
    private constructor(
        ...
        ) : this(id, checkoutIntentId, createdAt, marketplaceOrderId, reason, state, mutableMapOf())
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [RequestedCancellation].
             *
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CompletedCancellation].
             *
             * The following fields are required:
             * ```java
             * .id()
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun denialReason(denialReason: DenialReason) = denialReason(JsonField.of(denialReason))

            /**
             * Sets [Builder.denialReason] to an arbitrary JSON value.
             *
             * You should usually call [Builder.denialReason] with a well-typed [DenialReason] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
            ...
            class Code @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    @JvmField val CANCELLATION_WINDOW_EXPIRED = of("cancellation_window_expired")
