...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orderListParams: OrderListParams) = apply {
            after = orderListParams.after
            before = orderListParams.before
    ...
    override fun toString() =
        "OrderListParams{after=$after, before=$before, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
