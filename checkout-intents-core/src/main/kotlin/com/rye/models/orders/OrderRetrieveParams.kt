...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): OrderRetrieveParams =
            OrderRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "OrderRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
