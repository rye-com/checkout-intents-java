...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ReturnDenyParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ReturnDenyParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ReturnDenyParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(returnDenyParams: ReturnDenyParams) = apply {
            returnId = returnDenyParams.returnId
            body = returnDenyParams.body.toBuilder()
            additionalHeaders = returnDenyParams.additionalHeaders.toBuilder()
            additionalQueryParams = returnDenyParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ReturnDenyParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ReturnDenyParams =
            ReturnDenyParams(
                returnId,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(note, reason, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(note, reason, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{note=$note, reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReturnDenyParams &&
    ...
    override fun toString() =
        "ReturnDenyParams{returnId=$returnId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
