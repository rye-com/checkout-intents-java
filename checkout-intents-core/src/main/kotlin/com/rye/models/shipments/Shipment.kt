    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun carrierName(carrierName: String?) =
                    carrierName(JsonField.ofNullable(carrierName))
                 ...
                 */
                fun estimatedDeliveryDate(estimatedDeliveryDate: JsonField<OffsetDateTime>) =
                    apply {
            ...
            override fun toString() =
                "Tracking{number=$number, carrierName=$carrierName, estimatedDeliveryDate=$estimatedDeliveryDate, url=$url, additionalProperties=$additionalProperties}"
        }
