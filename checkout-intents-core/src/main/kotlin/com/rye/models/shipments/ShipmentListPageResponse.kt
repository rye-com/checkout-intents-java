...
class ShipmentListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<Shipment>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Shipment>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Shipment> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Shipment>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShipmentListPageResponse].
         *
    ...
    /** A builder for [ShipmentListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Shipment>>? = null
        private var pageInfo: JsonField<PageInfo>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(shipmentListPageResponse: ShipmentListPageResponse) = apply {
            data = shipmentListPageResponse.data.map { it.toMutableList() }
            pageInfo = shipmentListPageResponse.pageInfo
            additionalProperties = shipmentListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<Shipment>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Shipment>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Shipment>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Shipment] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Shipment) = apply {
            this.data =
        ...
        /** Alias for calling [addData] with `Shipment.ofDelivered(delivered)`. */
        fun addData(delivered: Shipment.DeliveredShipment) =
            addData(Shipment.ofDelivered(delivered))
         ...
         */
        fun addData(withStatusBaseShipmentOrdered: Shipment.WithStatusBaseShipmentOrdered) =
            addData(Shipment.ofWithStatusBaseShipmentOrdered(withStatusBaseShipmentOrdered))

        /**
         * Alias for calling [addData] with
         * `Shipment.ofWithStatusBaseShipmentCanceled(withStatusBaseShipmentCanceled)`.
         */
        fun addData(withStatusBaseShipmentCanceled: Shipment.WithStatusBaseShipmentCanceled) =
            addData(Shipment.ofWithStatusBaseShipmentCanceled(withStatusBaseShipmentCanceled))
        ...
        /**
         * Returns an immutable instance of [ShipmentListPageResponse].
         *
         ...
         */
        fun build(): ShipmentListPageResponse =
            ShipmentListPageResponse(
    ...
    fun validate(): ShipmentListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShipmentListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ShipmentListPageResponse{data=$data, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
